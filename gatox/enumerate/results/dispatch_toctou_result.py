...
class DispatchTOCTOUResult(AnalysisResult):
    ...
    def __init__(self, path: list, confidence_score: Confidence, attack_complexity_score: Complexity):

        repository_name = path[0].repo_name()

        super().__init__(repository_name, DispatchTOCTOUResult.__name__, confidence_score, attack_complexity_score)
