...
def test_complexity_explain():
    ...
    explanations = {
        Complexity.ZERO_CLICK: "Exploit requires no user interaction",
        ...
        Complexity.TOCTOU: "Exploit requires updating pull request quickly after the maintainer performs an approval action.",
